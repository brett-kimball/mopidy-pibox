...
class Extension(ext.Extension):
    ...
    def get_config_schema(self):
        ...
        schema["ws_pong_timeout_ms"] = config.Integer(optional=True, minimum=1000)        schema["pause_timeout_minutes"] = config.Integer(optional=True, minimum=0)        schema["volume_control"] = config.Boolean(optional=True)
